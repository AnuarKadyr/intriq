    ...
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/5 via-primary/10 to-purple-500/10 border border-primary/20 p-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                {selectedFolder ? (
                  <>Deep analysis of <span className="font-medium text-foreground">{selectedFolder.name}</span> data room</>
                ) : (
                  'Select a folder to begin AI-powered analysis'
                )}
              </p>
            </div>
          </div>
        ...
        <div className="relative mt-6 grid grid-cols-4 gap-4">
          {[
            { icon: FileSearch, label: 'Files Scanned', value: '154', color: 'text-primary' },
            { icon: Eye, label: 'Issues Found', value: '4', color: 'text-amber-500' },
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl p-6 text-white">
        {/* Decorative elements */}
        ...
        <div className="relative">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-xs font-medium text-emerald-400 uppercase tracking-wider">AI Summary</span>
          </div>
          ...
          <p className="text-white/90 leading-relaxed">
            ...
            repository with <span className="text-emerald-400 font-medium">154 files</span> organized across 
          ...
          <div className="mt-4 pt-4 border-t border-white/10">
            <div className="flex items-center gap-3">
              <div className="flex -space-x-1">
                <div className="w-6 h-6 rounded-full bg-primary/80 flex items-center justify-center text-[10px] font-bold">AI</div>
              </div>
              <span className="text-xs text-white/60">Generated by Intriq AI • Updated just now</span>
            </div>
          </div>
        </div>
      </div>
